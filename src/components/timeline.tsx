    ...
    <section id="timeline" className="w-full py-16 px-4 sm:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Vertical Line */}
          <div className="absolute left-[120px] sm:left-[140px] top-0 bottom-0 w-0.5 bg-border" />
          ...
          <div className="space-y-12">
            {timelineData.map((item, index) => (
              <div key={index} className="relative flex items-start gap-6">
                {/* Year Label (Left) */}
                <div className="w-[100px] sm:w-[120px] text-right shrink-0">
                ...
                {/* Content (Right) */}
                <div className="flex-1 min-w-0 flex gap-4 sm:gap-6 items-start">
                  {/* Logo */}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {!item.subsections && item.highlights && (
                      <div className="text-foreground/80 text-sm sm:text-base leading-relaxed space-y-2">
